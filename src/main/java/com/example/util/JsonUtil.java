...
public class JsonUtil {
    ...
    public static <T> List<T> toList(String json, Class<T> clazz) throws IOException {
        ...
        JavaType javaType = mapper.getTypeFactory().constructParametrizedType(List.class, List.class, clazz);
    ...
    public static <T> Map<String, T> toMap(String jsonText, Class<T> clazz) throws IOException {
        JavaType javaType = mapper.getTypeFactory().constructParametrizedType(Map.class, String.class, clazz);
